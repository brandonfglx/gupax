...
impl Default for UpdateSettings {
    fn default() -> Self {
        Self {
            ...
            gupax_source: "github.com/gupax-io/gupax".to_owned(),
            node_version: "v0.18.4.5".to_owned(),
            node_source: "github.com/monero-project/monero".to_owned(),
            p2pool_version: "v4.14".to_owned(),
            p2pool_source: "github.com/SChernykh/p2pool".to_owned(),
            xmrig_version: "v6.25.0".to_owned(),
            xmrig_source: "github.com/xmrig/xmrig".to_owned(),
            proxy_version: "v6.24.0".to_owned(),
            proxy_source: "github.com/xmrig/xmrig-proxy".to_owned(),
...
pub struct Xvb {
    ...
    pub manual_timeframe_minutes: u32,
    pub console_height: u32,
