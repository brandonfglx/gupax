...
pub const GUPAX_RENDERER: &str = "If you experience freezes, try the other renderer.If Gupax crashes, it will automatically restart the GUI with the other renderer.";
